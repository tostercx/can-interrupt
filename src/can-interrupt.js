/**
 * @module {?} can.Map.interrupt Map Plugin
 *
 * @description The can.Map.interrupt plugin allows you to interrupt the setting of a property (or properties) on can.Map in a transaction.
 *
 * @body
 *
 * ## Initialization
 * Import the interrupt plugin.
 * ```js
 * import 'can-interrupt/map/interrupt';
 *```
 *
 * @demo ./can-interrupt/map/interrupt/demo.html
 *
 *
 */
...
var mapProto = can.Map.prototype;
var oldSet = mapProto.__set;
var oldRemove = mapProto._remove;
